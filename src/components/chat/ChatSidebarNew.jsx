...
export default function ChatSidebarNew({
  chats = [],
  activeChatId,
  onNewChat,
  onSelectChat,
  ...
  const [renameChat, setRenameChat] =
    useState(null);
                    ...
                    {openMenuId ===
                      ...
                      <div className="absolute right-2 top-10 z-50 w-36 bg-white border border-[#D9DADF] rounded-xl shadow-lg py-1">
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2.5 text-left text-sm text-[#45474C] hover:bg-[#F1F2F4] transition-colors"
                        >
                          {chat.pinned
                            ? "📌 Unpin"
                            : "📌 Pin"}
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2.5 text-left text-sm text-red-600 hover:bg-red-50 transition-colors"
                        >
                          🗑️ Delete
                        </button>
